...
public class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void setDelayAnimations(boolean delayAnimations) {
    ...
    private class AnimationInfo extends ItemHolderInfo {
        int pos;
        int oldPos;
        int width;
        int height;
        ...
        public ItemHolderInfo setFrom(RecyclerView.ViewHolder holder) {
            setAnimationInfoFrom(this, holder);
            return super.setFrom(holder);
        }

    }

    protected void setAnimationInfoFrom(AnimationInfo animationInfo, RecyclerView.ViewHolder holder) {
        if (animationInfo != null && holder != null) {
            animationInfo.pos = holder.getAdapterPosition();
            animationInfo.oldPos = holder.getOldPosition();
            animationInfo.width = holder.itemView.getWidth();
            animationInfo.height = holder.itemView.getHeight();
        }
    }
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, mover, delayAnimations ? getRemoveDuration() : 0);
            } else {
                mover.run();
            }
        }
        ...
        if (additionsPending) {
            ...
            if (removalsPending || movesPending || changesPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, adder, delayAnimations ? totalDelay : 0);
            } else {
                adder.run();
            }
        }
    ...
    protected void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(this.getRemoveDuration()).alpha(0.0F).setListener(new VpaListenerAdapter() {
    ...
    protected void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.alpha(1.0F).setDuration(this.getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
